...
final class WebAuthnManagerRegistrationECDSATests: XCTestCase {
    ...
    override func setUp() {
        ...
        webAuthnManager = .init(configuration: configuration, challengeGenerator: MockChallengeGenerator.mock(generate: challenge))
    }
    ...
    func testFinishRegistrationFailsIfExtensionDataFlagIsSetButThereIsNoExtensionData() async throws {
        try await assertThrowsError(
            await finishRegistration(
                attestationObject: TestAttestationObjectBuilder()
                    .validMockECDSA()
                    .authData(TestAuthDataBuilder().validMockECDSA().noExtensionData().flags(0b11000001))
                    .build()
                    .cborEncoded
            ),
    ...
    func testFinishRegistrationFailsIfRelyingPartyIDHashDoesNotMatch() async throws {
        try await assertThrowsError(
            await finishRegistration(
                attestationObject: TestAttestationObjectBuilder()
                    .validMockECDSA()
                    .authData(TestAuthDataBuilder().validMockECDSA().relyingPartyIDHash(fromRelyingPartyID: "invalid-id.com"))
                    .build()
                    .cborEncoded
            ),
    ...
    func testFinishRegistrationFailsIfUserPresentFlagIsNotSet() async throws {
        try await assertThrowsError(
            await finishRegistration(
                attestationObject: TestAttestationObjectBuilder()
                    .validMockECDSA()
                    .authData(TestAuthDataBuilder().validMockECDSA().flags(0b11000000))
                    .build()
                    .cborEncoded
            ),
    ...
    func testFinishRegistrationFailsIfUserVerificationFlagIsNotSetButRequired() async throws {
        try await assertThrowsError(
            await finishRegistration(
                attestationObject: TestAttestationObjectBuilder()
                    .validMockECDSA()
                    .authData(TestAuthDataBuilder().validMockECDSA().flags(0b11000001))
                    .build()
                    .cborEncoded,
    ...
    func testFinishRegistrationSucceeds() async throws {
        ...
        let credentialPublicKey: [UInt8] = TestCredentialPublicKeyBuilder().validMockECDSA().buildAsByteArray()
    ...
    private func finishRegistration(
        ...
        attestationObject: [UInt8] = TestAttestationObjectBuilder().validMockECDSA().build().cborEncoded,
